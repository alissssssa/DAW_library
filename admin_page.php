...
<html lang="en">
  <head>
    ...
    <title> Admin page | Salient</title>
...
<div class="box-container">
   ...
   <div class="box">
      <?php 
      $query2= "SELECT* FROM counter_table_unique where ip_address='$visitor_ip'";
      $result2=mysqli_query($conn,$query2);
      if (!$result2){
         die("Retriving query error <br>".$query2);}
      $total_unique_visitors= mysqli_num_rows($result2);
      if($total_unique_visitors<1){
         $query2= "INSERT INTO counter_table_unique (ip_address) VALUES ('$visitor_ip')";
         $result2=mysqli_query($conn,$query2);
      }
      ?>
      <h3><?php echo $total_unique_visitors; ?></h3>
      <p>unique visitors</p>
   </div>
